...
Config.CloseUiItems = {"headbag", "tunerchip", "cigarette", "rarecigar", "cigar", "fixkit", "fixkit_large", "cloth", "notepad", "lotteryticket", "lockpick", "fishingrod", "crowbar", "transmitter", "binoculars", "headbag", "dice", "bulletproof_vest", "medikit", "bandage", "vicodin", "gauze", "morphine", "radio"}
